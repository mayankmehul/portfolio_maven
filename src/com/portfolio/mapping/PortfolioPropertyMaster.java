...
/**
 * PortfolioPropertyMaster entity. @author MyEclipse Persistence Tools
 */

@Entity
public class PortfolioPropertyMaster implements java.io.Serializable {
	...
	/** default constructor */
	public PortfolioPropertyMaster() {
	}

	/** full constructor */
	public PortfolioPropertyMaster(String propertyCode, String propertyDevName,
